...
public class CoreAppContext(DbContextOptions options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<FollowedPeople>(b =>
        {
            ...
            // app.ApplicationServices.GetRequiredService<CoreApp.APIContext>().Database.EnsureCreated(); throws the following error:
