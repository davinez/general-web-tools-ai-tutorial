  ...
  )
  {
    ...
    switch (exception)
    {
      case RestException re:
        ...
        break;
      case CoreAppException cae:
        context.Response.StatusCode = (int)HttpStatusCode.Conflict;
        result = JsonSerializer.Serialize(new { errors = cae.Message });
        break;
      case RemoteServiceException rse:
        context.Response.StatusCode = (int)HttpStatusCode.Conflict;
        result = JsonSerializer.Serialize(new { errors = rse.Message });
        break;
