...
using CoreApp.Features.Articles;
...
public class DeleteTests : SliceFixture
{
    ...
    public async Task Expect_Delete_Article_With_Comments()
    {
        ...
        var createCommentCmd = new CoreApp.Features.Comments.Create.Command(
            new(new CoreApp.Features.Comments.Create.CommentData("article comment")),
